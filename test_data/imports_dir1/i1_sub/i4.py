...
# TODO: ref/file should be processed through absolute_name
#- { @".." ref/file vname("", _, _, "${ROOT_DIR}/test_data/imports_dir1/i1_sub/i4/..", "") }
#- { @i5 ref/imports I5_imports? }  // TODO: should be .../i5.py
from .. import i5

# TODO: ref/file should be processed through absolute_name
#- { @"..i8.i9" ref/file vname("", _, _, "${ROOT_DIR}/test_data/imports_dir1/i1_sub/i4/../i8/i9", "") }
#- { @i9_loc ref/imports I9_loc_imports? }  // TODO: loc should be test_data.imports_dir.i8.i9.loc

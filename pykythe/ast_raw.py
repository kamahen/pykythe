...
# The following requires python3.11 -m pip install mypy_extensions
...
def cvt_typedargslist(node: pytree.Base, ctx: Ctx) -> ast_cooked.Base:
    ...
    # DO NOT SUBMIT - Python3.9 allows this (!):
...
def parse(src_file: ast_node.File, python_version: int) -> Union['Node', 'Leaf']:
    ...
    # The check is generated by this command: sha1sum /usr/lib/python3.11/lib2to3/Grammar.txt
    with open(pygram._GRAMMAR_FILE, 'rb') as grammar_file:
        if (hashlib.sha1(grammar_file.read()).hexdigest() !=
                    '8614a1c350b849496b04fc33502e10045b1e79b9'):
            raise RuntimeError(
    ...
    #       reprocess /usr/lib/python3.11/lib2to3/Grammar.txt
    #       each time?
    #         from lib2to3 import pgen2, pygram
    #         pygram._GRAMMAR_FILE = '/usr/lib/python3.11/lib2to3/Grammar.txt',
    #         pgen2.driver._generate_pickle_name(os.path.basename(pygram._GRAMMAR_FILE)) = 'Grammar3.11.13.final.0.pickle')

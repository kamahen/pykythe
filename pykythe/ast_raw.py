...
# The following requires python3.9 -m pip install mypy_extensions
...
def parse(src_file: ast_node.File, python_version: int) -> Union['Node', 'Leaf']:
    ...
    # The check is generated by this command: sha1sum /usr/lib/python3.9/lib2to3/Grammar.txt
    ...
    #       reprocess /usr/lib/python3.9/lib2to3/Grammar.txt
    #       each time?
    #         from lib2to3 import pgen2, pygram
    #         pygram._GRAMMAR_FILE = '/usr/lib/python3.9/lib2to3/Grammar.txt',
    #         pgen2.driver._generate_pickle_name(os.path.basename(pygram._GRAMMAR_FILE)) = 'Grammar3.9.13.final.0.pickle')

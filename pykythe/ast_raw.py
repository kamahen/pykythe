...
def parse(src_file: ast.File, python_version: int) -> Union['Node', 'Leaf']:
    """Parse a file."""
    # First, verify that the Grammar.txt file matches what we expect.
    # The check is generated by: 'sha1sum pygram_Grammar.txt'

...
def main() -> int:
    ...
    with open(args.srcpath, 'rb') as src_f:
        ...
        src_file = ast.make_file(
            path=args.srcpath, content=src_content,
    ...
    add_fqns = ast_cooked.add_fqns(cooked_nodes, args.module, args.python_version)
    ...
    meta = ast_cooked.Meta(
        ...
        contents=src_content.decode('utf8'),  # TODO: delete (for debugging only)

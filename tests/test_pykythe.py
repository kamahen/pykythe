...
from pykythe import (ast_node, ast_cooked, ast_raw, fakesys, typing_debug, pod, ast_color)  # pylint: disable=wrong-import-position
...
class TestAnchor(unittest.TestCase):
    ...
    def test_leafs(self) -> None:
        ...
        for python_version in (3, ):  # Might change in future: fakesys.FAKE_SYS.version_info
            src_file = ast_node.make_file_from_contents('<>', src_bytes)
            ...
            anchor_file = ast_node.make_file_from_contents('<>', src_bytes)
            leaf_nodes = [
...
class TestColor(unittest.TestCase):
    ...
    def test_color(self) -> None:
        src_bytes = (
                ...
                '  # Comment 4\n'  # Line 7
                '  bcd = "<br/>"\n').encode('utf-8')  # Line 8
        src_file = ast_node.make_file_from_contents(path='<string>', contents_bytes=src_bytes)
        for python_version in (3, ):  # Might change in future: fakesys.FAKE_SYS.version_info
            parse_tree = ast_raw.parse(src_file, python_version)
            for node in parse_tree.pre_order():
                if isinstance(node, pytree.Leaf):
            ...
            self.assertEqual(colored, [
                    ast_color.Color(astn=ast_node.Astn(value='# A comment', start=0, end=11),
                                    lineno=1,
                                    column=0,
                                    token_type='<COMMENT>'),
                    ast_color.Color(astn=ast_node.Astn(value='\n', start=11, end=12),
                                    lineno=1,
                                    column=11,
                                    token_type='<NEWLINE>'),
                    ast_color.Color(astn=ast_node.Astn(value='a', start=12, end=13),
                                    lineno=2,
                                    column=0,
                                    token_type='<NAME>'),
                    ast_color.Color(astn=ast_node.Astn(value=',', start=13, end=14),
                                    lineno=2,
                                    column=1,
                                    token_type='<PUNCTUATION>'),
                    ast_color.Color(astn=ast_node.Astn(value=' ', start=14, end=15),
                                    lineno=2,
                                    column=2,
                                    token_type='<WHITESPACE>'),
                    ast_color.Color(astn=ast_node.Astn(value='(', start=15, end=16),
                                    lineno=2,
                                    column=3,
                                    token_type='<PUNCTUATION>'),
                    ast_color.Color(astn=ast_node.Astn(value='b', start=16, end=17),
                                    lineno=2,
                                    column=4,
                                    token_type='<NAME>'),
                    ast_color.Color(astn=ast_node.Astn(value=',', start=17, end=18),
                                    lineno=2,
                                    column=5,
                                    token_type='<PUNCTUATION>'),
                    ast_color.Color(astn=ast_node.Astn(value=' ', start=18, end=19),
                                    lineno=2,
                                    column=6,
                                    token_type='<WHITESPACE>'),
                    ast_color.Color(astn=ast_node.Astn(value='x', start=19, end=20),
                                    lineno=2,
                                    column=7,
                                    token_type='<NAME>'),
                    ast_color.Color(astn=ast_node.Astn(value=')', start=20, end=21),
                                    lineno=2,
                                    column=8,
                                    token_type='<PUNCTUATION>'),
                    ast_color.Color(astn=ast_node.Astn(value=' ', start=21, end=22),
                                    lineno=2,
                                    column=9,
                                    token_type='<WHITESPACE>'),
                    ast_color.Color(astn=ast_node.Astn(value='=', start=22, end=23),
                                    lineno=2,
                                    column=10,
                                    token_type='<PUNCTUATION>'),
                    ast_color.Color(astn=ast_node.Astn(value=' ', start=23, end=24),
                                    lineno=2,
                                    column=11,
                                    token_type='<WHITESPACE>'),
                    ast_color.Color(astn=ast_node.Astn(value='y', start=24, end=25),
                                    lineno=2,
                                    column=12,
                                    token_type='<NAME>'),
                    ast_color.Color(astn=ast_node.Astn(value=' ', start=25, end=26),
                                    lineno=2,
                                    column=13,
                                    token_type='<WHITESPACE>'),
                    ast_color.Color(astn=ast_node.Astn(value='=', start=26, end=27),
                                    lineno=2,
                                    column=14,
                                    token_type='<PUNCTUATION>'),
                    ast_color.Color(astn=ast_node.Astn(value=' ', start=27, end=28),
                                    lineno=2,
                                    column=15,
                                    token_type='<WHITESPACE>'),
                    ast_color.Color(astn=ast_node.Astn(value='1', start=28, end=29),
                                    lineno=2,
                                    column=16,
                                    token_type='<NUMBER>'),
                    ast_color.Color(astn=ast_node.Astn(value='  ', start=29, end=31),
                                    lineno=2,
                                    column=17,
                                    token_type='<WHITESPACE>'),
                    ast_color.Color(astn=ast_node.Astn(value='# Binds `a`, `b`', start=31, end=47),
                                    lineno=2,
                                    column=19,
                                    token_type='<COMMENT>'),
                    ast_color.Color(astn=ast_node.Astn(value='\n', start=47, end=48),
                                    ...
                                    column=35,
                                    token_type='<NEWLINE>'),
                    ast_color.Color(astn=ast_node.Astn(value='# Comment 2', start=48, end=59),
                                    lineno=3,
                                    column=0,
                                    token_type='<COMMENT>'),
                    ast_color.Color(astn=ast_node.Astn(value='\n', start=59, end=60),
                    ...
                    ast_color.Color(astn=ast_node.Astn(value='\n', start=60, end=61),
                                    ...
                                    column=0,
                                    token_type='<NEWLINE>'),
                    ast_color.Color(astn=ast_node.Astn(value='# Comment 3', start=61, end=72),
                                    lineno=5,
                                    column=0,
                                    token_type='<COMMENT>'),
                    ast_color.Color(astn=ast_node.Astn(value='\n', start=72, end=73),
                                    ...
                                    column=11,
                                    token_type='<NEWLINE>'),
                    ast_color.Color(astn=ast_node.Astn(value='if', start=73, end=75),
                                    lineno=6,
                                    column=0,
                                    token_type='<KEYWORD>'),
                    ast_color.Color(astn=ast_node.Astn(value=' ', start=75, end=76),
                                    lineno=6,
                                    column=2,
                                    token_type='<WHITESPACE>'),
                    ast_color.Color(astn=ast_node.Astn(value='a', start=76, end=77),
                                    lineno=6,
                                    column=3,
                                    token_type='<NAME>'),
                    ast_color.Color(astn=ast_node.Astn(value=' ', start=77, end=78),
                                    lineno=6,
                                    column=4,
                                    token_type='<WHITESPACE>'),
                    ast_color.Color(astn=ast_node.Astn(value='==', start=78, end=80),
                                    lineno=6,
                                    column=5,
                                    token_type='<PUNCTUATION>'),
                    ast_color.Color(astn=ast_node.Astn(value=' ', start=80, end=81),
                                    lineno=6,
                                    column=7,
                                    token_type='<WHITESPACE>'),
                    ast_color.Color(astn=ast_node.Astn(value='234', start=81, end=84),
                                    lineno=6,
                                    column=8,
                                    token_type='<NUMBER>'),
                    ast_color.Color(astn=ast_node.Astn(value=':', start=84, end=85),
                                    lineno=6,
                                    column=11,
                                    token_type='<PUNCTUATION>'),
                    ast_color.Color(astn=ast_node.Astn(value='  ', start=85, end=87),
                                    lineno=6,
                                    column=12,
                                    token_type='<WHITESPACE>'),
                    ast_color.Color(astn=ast_node.Astn(value='# Ref `a`', start=87, end=96),
                                    lineno=6,
                                    column=14,
                                    token_type='<COMMENT>'),
                    ast_color.Color(astn=ast_node.Astn(value='\n', start=96, end=97),
                                    ...
                                    column=23,
                                    token_type='<NEWLINE>'),
                    ast_color.Color(astn=ast_node.Astn(value='  ', start=97, end=99),
                                    lineno=7,
                                    column=0,
                                    token_type='<WHITESPACE>'),
                    ast_color.Color(astn=ast_node.Astn(value='# Comment 4', start=99, end=110),
                                    lineno=7,
                                    column=2,
                                    token_type='<COMMENT>'),
                    ast_color.Color(astn=ast_node.Astn(value='\n', start=110, end=111),
                                    ...
                                    column=13,
                                    token_type='<NEWLINE>'),
                    ast_color.Color(astn=ast_node.Astn(value='  ', start=111, end=113),
                                    lineno=8,
                                    column=0,
                                    token_type='<WHITESPACE>'),
                    ast_color.Color(astn=ast_node.Astn(value='bcd', start=113, end=116),
                                    lineno=8,
                                    column=2,
                                    token_type='<NAME>'),
                    ast_color.Color(astn=ast_node.Astn(value=' ', start=116, end=117),
                                    lineno=8,
                                    column=5,
                                    token_type='<WHITESPACE>'),
                    ast_color.Color(astn=ast_node.Astn(value='=', start=117, end=118),
                                    lineno=8,
                                    column=6,
                                    token_type='<PUNCTUATION>'),
                    ast_color.Color(astn=ast_node.Astn(value=' ', start=118, end=119),
                                    lineno=8,
                                    column=7,
                                    token_type='<WHITESPACE>'),
                    ast_color.Color(astn=ast_node.Astn(value='"<br/>"', start=119, end=126),
                                    lineno=8,
                                    column=8,
                                    token_type='<STRING>'),
                    ast_color.Color(astn=ast_node.Astn(value='\n', start=126, end=127),
